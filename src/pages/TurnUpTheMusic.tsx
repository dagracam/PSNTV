...
const TurnUpTheMusic: React.FC = () => {
  const program = programs.find((p) => p.id === 'turn-up-the-music');
    ...
    return (
      <Layout>
        <div className="max-w-4xl mx-auto text-center py-10">
          ...
          <p className="text-lg text-dyad-text/80">Siamo spiacenti, il programma "Turn up the Music" non esiste.</p>
        </div>
      </Layout>
    );
  }
