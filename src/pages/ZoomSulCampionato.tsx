...
const ZoomSulCampionato: React.FC = () => {
  const program = programs.find((p) => p.id === 'zoom-sul-campionato');
    ...
    return (
      <Layout>
        <div className="max-w-4xl mx-auto text-center py-10">
          ...
          <p className="text-lg text-dyad-text/80">Siamo spiacenti, il programma "Zoom sul Campionato" non esiste.</p>
        </div>
      </Layout>
    );
  }
...
export default ZoomSulCampionato;