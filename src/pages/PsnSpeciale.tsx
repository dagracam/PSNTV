...
const PsnSpeciale: React.FC = () => {
  const program = programs.find((p) => p.id === 'psn-speciale');
    ...
    return (
      <Layout>
        <div className="max-w-4xl mx-auto text-center py-10">
          ...
          <p className="text-lg text-dyad-text/80">Siamo spiacenti, il programma "PSN Speciale" non esiste.</p>
        </div>
      </Layout>
    );
  }
