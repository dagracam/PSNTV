...
const IntervistaloTu: React.FC = () => {
  const program = programs.find((p) => p.id === 'intervistalo-tu');
    ...
    return (
      <Layout>
        <div className="max-w-4xl mx-auto text-center py-10">
          ...
          <p className="text-lg text-dyad-text/80">Siamo spiacenti, il programma "Intervistalo Tu" non esiste.</p>
        </div>
      </Layout>
    );
  }
