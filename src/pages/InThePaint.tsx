...
const InThePaint: React.FC = () => {
  const program = programs.find((p) => p.id === 'in-the-paint');
    ...
    return (
      <Layout>
        <div className="max-w-4xl mx-auto text-center py-10">
          ...
          <p className="text-lg text-dyad-text/80">Siamo spiacenti, il programma "In the Paint" non esiste.</p>
        </div>
      </Layout>
    );
  }
