...
const LaVitaQuestoPalcoscenico: React.FC = () => {
  const program = programs.find((p) => p.id === 'la-vita-questo-palcoscenico');
    ...
    return (
      <Layout>
        <div className="max-w-4xl mx-auto text-center py-10">
          ...
          <p className="text-lg text-dyad-text/80">Siamo spiacenti, il programma "La Vita questo Palcoscenico" non esiste.</p>
        </div>
      </Layout>
    );
  }
...
export default LaVitaQuestoPalcoscenico;